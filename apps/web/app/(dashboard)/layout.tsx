    ...
    <PrivateRoute>
      <WebSocketProvider>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-slate-950">
          {/* Topbar */}
          <header className="h-16 border-b border-slate-800/80 flex items-center justify-between px-8 bg-slate-900/30 backdrop-blur-md gap-4">
            <div className="flex-1 max-w-md">
              <SymbolSearch />
            </div>
            <div className="flex items-center space-x-4 flex-shrink-0">
              <span className="text-sm text-slate-400 font-semibold hidden md:inline-block">
